# 脚本 L3 · MVMR 全暴露 qhet（2026-09-14 修复版，加载 MendelianRandomization）
...
saveRDS(list(m = m, fit_mvmr = fit_mvmr, qh = qh), "D:/gwas/tmp/mvmr_qhet_20260914.rds")
